  ...
  return (
      <>
        <div className="form-group mx-5 my-3">
            ...
            <textarea className="form-control my-3" rows="18" value={text} onChange={onChanges}></textarea> 
        </div>
        <div className="d-flex justify-content-evenly flex-wrap mx-5 my-1">
            <button className="btn btn-outline-dark m-1 my-2" onClick={upClick} title="Upper Case">
                  <i className="fa-solid fa-angle-up me-2"></i>Capital
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={lowClick} title="Lower Case">
                <i className="fa-solid fa-angle-down me-2"></i>Small
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={clearClick} title="Clear">
                <i className="fa-solid fa-minus me-2"></i>Clear
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={copyClick} title="Copy">
                <i className="fa-regular fa-clipboard me-2"></i>Copy
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={displayClick} title="Display Content">
                <i className="fa-regular fa-file-lines me-2"></i>Display
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={displayLength} title="Display Length">
                <i className="fa-solid fa-text-height me-2"></i>Length
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={displayWords} title="Display Words">
                <i className="fa-regular fa-file-word me-2"></i>Words
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={readTime} title="Time to Read">
                <i className="fa-regular fa-clock me-2"></i>Time
            </button>
            <button className="btn btn-outline-dark m-1 my-2" title="Listen">
                <i className="fa-solid fa-headphones me-2"></i>Listen
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={displaySenLen} title="Display Sentences">
                <i className="fa-solid fa-strikethrough me-2"></i>Sentences
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={extraSpaces} title="Remove Extra Spaces">
                <i className="fa-solid fa-text-width me-2"></i>Extra Spaces
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={displayPunc} title="Display Punctuations">
                <i className="fa-brands fa-product-hunt me-2"></i>Punctuations
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={displayConsonants} title="Display Consonants">
                <i class="fa-regular fa-copyright me-2"></i>Consonants
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={displayVowels} title="Display Vowels">
                <i className="fa-brands fa-vimeo-v me-2"></i>Vowels
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={removeVowels} title="Remove Vowels">
                <i className="fa-brands fa-viacoin me-2"></i>Remove Vowels
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={displaySpaces} title="Display Spaces">
                <i className="fa-regular fa-square me-2"></i>Spaces
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={removeSpaces} title="Remove Spaces">
                <i className="fa-solid fa-square me-2"></i>Remove Spaces
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={displaySpecial} title="Display Special">
                <i className="fa-solid fa-dollar me-2"></i>Special
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={removeSpecial} title="Remove Special">
                <i class="fa-brands fa-creative-commons-nc me-2"></i>Remove Special
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={displayNum} title="Display Numbers">
                <i class="fa-brands fa-creative-commons-zero me-2"></i>Numbers
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={inverseClick} title="Reverse Content">
                <i className="fa-solid fa-clock-rotate-left me-2"></i>Reverse
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={removeConsonants} title="Remove Consonants">
                <i class="fa-brands fa-creative-commons-pd me-2"></i>Remove Consonants
            </button>
            <button className="btn btn-outline-dark m-1 my-2" onClick={removeNum} title="Remove Numbers">
                <i class="fa-solid fa-cruzeiro-sign me-2"></i>Remove Numbers
            </button>
            
            <button className="btn btn-outline-dark m-1 my-2" onClick={removePunc} title="Remove Punctuations">
